...
/*void animate_rocket(float elapsed_microseconds)
	...
	rocket_position.x = sin(rocket_angle);
	rocket_position.z = cos(rocket_angle);
	rocket_position.y = 0;
...
UINT offset = 0;
	...
	if (i < 30) {
		...
		billboard *new_bill = new billboard;
		/*new_bill->position.x = rocket_position.x + i;
		new_bill->position.y = rocket_position.y + i;
		new_bill->position.z = rocket_position.z + i;*/

		switch (i)
		{
		default:break;
		case 0:
			new_bill->position.x = rocket_position.x + 1;
			new_bill->position.y = rocket_position.y + 0;
			new_bill->position.z = rocket_position.z + 1;
			break;
		case 1:
			new_bill->position.x = rocket_position.x + 1.75;
			new_bill->position.y = rocket_position.y + .75;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 2:
			new_bill->position.x = rocket_position.x - .75;
			new_bill->position.y = rocket_position.y + .75;
			new_bill->position.z = rocket_position.z + 1;
			break;
		case 3:
		...
		case 4:
			new_bill->position.x = rocket_position.x + .75;
			new_bill->position.y = rocket_position.y + 1.75;
			new_bill->position.z = rocket_position.z + 1;
			break;
		case 5:
			new_bill->position.x = rocket_position.x + 1.5;
			new_bill->position.y = rocket_position.y + 1.25;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 6:
			new_bill->position.x = rocket_position.x;
			new_bill->position.y = rocket_position.y;
			new_bill->position.z = rocket_position.z;
			break;
		case 7:
			new_bill->position.x = rocket_position.x + .5;
			new_bill->position.y = rocket_position.y + .5;
			new_bill->position.z = rocket_position.z + 1;
			break;
		case 8:
			new_bill->position.x = rocket_position.x + 1.5;
			new_bill->position.y = rocket_position.y + 1.5;
			new_bill->position.z = rocket_position.z + 1;
			break;
		case 9:
			new_bill->position.x = rocket_position.x - .5;
			...
			break;
		case 10:
			new_bill->position.x = rocket_position.x - .25;
			new_bill->position.y = rocket_position.y + 0;
			new_bill->position.z = rocket_position.z + 1;
			break;
		case 11:
			new_bill->position.x = rocket_position.x + .5;
			new_bill->position.y = rocket_position.y - .25;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 12:
			new_bill->position.x = rocket_position.x + .25;
			new_bill->position.y = rocket_position.y + 1;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 13:
			new_bill->position.x = rocket_position.x + 0;
			new_bill->position.y = rocket_position.y - .25;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 14:
		...
		case 15:
			...
			break;
		case 16:
			new_bill->position.x = rocket_position.x + 1.25;
			new_bill->position.y = rocket_position.y - .25;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 17:
		...
		case 24:
			...
			break;
		case 25:
			new_bill->position.x = rocket_position.x + 2;
			new_bill->position.y = rocket_position.y + 1;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 26:
		...
		case 27:
			...
			break;
		case 28:
			new_bill->position.x = rocket_position.x - 1.625;
			new_bill->position.y = rocket_position.y + 0;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 29:
			new_bill->position.x = rocket_position.x + 2.5;
			new_bill->position.y = rocket_position.y + 0;
			new_bill->position.z = rocket_position.z + 0;
			break;
		case 30:
			new_bill->position.x = rocket_position.x - 2.6;
			new_bill->position.y = rocket_position.y + 0;
			new_bill->position.z = rocket_position.z + 0;
			break;
		}
	...
	g_pImmediateContext->PSSetShaderResources(1, 1, &normaltex);
	g_pImmediateContext->IASetVertexBuffers(0, 1, &g_pVertexBuffer, &stride, &offset);
    g_pImmediateContext->PSSetSamplers( 0, 1, &g_pSamplerLinear );

	g_pImmediateContext->OMSetDepthStencilState(ds_off, 1);
    g_pImmediateContext->Draw( 0, 0 );
